...
def pytest_addoption(parser: pytest.Parser) -> None:
    ...
    parser.addoption(
        ...
        help="Base URL for Sauce Demo UI tests",
    )
    parser.addoption(
        "--booker-url",
        action="store",
        default="https://restful-booker.herokuapp.com",
        help="Base URL for Restful Booker API tests",
    )
    parser.addoption(
        "--selenium-headed",
        action="store_true",
...
def pytest_runtest_makereport(item: pytest.Item, call: pytest.CallInfo) -> None:
    ...
    try:
        ...
        logging.getLogger(__name__).warning("Failed to capture page source: %s", exc)


@pytest.fixture(scope="session")
def base_url(request: pytest.FixtureRequest) -> str:
    return request.config.getoption("--saucedemo-url")


@pytest.fixture(scope="session")
def booker_url(request: pytest.FixtureRequest) -> str:
    return request.config.getoption("--booker-url")
